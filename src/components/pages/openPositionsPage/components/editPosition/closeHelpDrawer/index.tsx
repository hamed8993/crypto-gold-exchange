...
interface CloseHelpDrawerProps {
  isOpen: boolean;
  onClose: () => void;
}

function CloseHelpDrawer({ isOpen, onClose }: CloseHelpDrawerProps) {
    ...
    >
      <div className="flex h-72 flex-col items-center justify-between px-8 py-2 pb-4">
        ...
        <p dir="rtl" className="text-accentText w-[90%] text-justify text-xs/6">
          {t("editPositionHelpDescription1")}
        </p>
        <p dir="rtl" className="text-accentText w-[90%] text-justify text-xs/6">
          {t("editPositionHelpDescription11")}
        </p>
...
export default CloseHelpDrawer;
