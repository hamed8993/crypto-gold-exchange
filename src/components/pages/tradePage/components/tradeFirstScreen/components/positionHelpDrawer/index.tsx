...
interface PositionHelpDrawerProps {
  isOpen: boolean;
  onClose: () => void;
}

function PositionHelpDrawer({ isOpen, onClose }: PositionHelpDrawerProps) {
...
export default PositionHelpDrawer;
