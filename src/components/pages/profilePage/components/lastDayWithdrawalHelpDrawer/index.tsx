...
interface LastDayWithdrawalHelpDrawerProps {
  isOpen: boolean;
  onClose: () => void;
}

function LastDayWithdrawalHelpDrawer({
  isOpen,
  onClose,
}: LastDayWithdrawalHelpDrawerProps) {
...
export default LastDayWithdrawalHelpDrawer;
